...
<footer class="bg-[#222222]">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <span class="self-center text-8xl font-semibold whitespace-nowrap text-white">Ògbómọ̀ṣọ́</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text font-semibold text-white">About</h2>
                  <ul class="text-white ">
                      <li class="mb-2">
                      ...
                      <li class="mb-2">
                          <a href="https://tailwindcss.com/" class="hover:underline">News & Blogs</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white">Contact</h2>
                  <ul class="text-white ">
                      <li class="mb-2">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">imbibe™</a>. All Rights Reserved.
          </span>
